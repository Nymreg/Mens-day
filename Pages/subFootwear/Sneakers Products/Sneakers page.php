...
<head>
  ...
  <link rel="stylesheet" href="Sneakers page.css" />
...
<nav class="navbar navbar-expand-lg">
  <div class="container d-flex justify-content-between align-items-center">
    ...
    <div class="d-flex align-items-center gap-4">
      ...
      <a href="#cartModalOverlay" id="cartIcon">
...
<div class="content">
  <div class="header d-flex flex-column">
    <h6>Products</h6>
    <h2 style="font-weight: bold;">Sneakers</h2>
    <h4>Featured</h4>
  </div>
  ...
  <div class="products">
    <div class="row">
      <div class="col-md-4">
        <div class="product-box" data-name="NeonPulse Sneakers" data-color="Black & White" data-image="sneakers1.jpg"
          data-price="140">
          <div class="image-container">
            <img src="sneakers1.jpg" alt="Image1" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>NeonPulse Sneakers</h6>
                <p class="text-muted">Black & White</p>
              </div>
              <h6>$140</h6>
            </div>
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="AeroVoid Runners" data-color="Beige & Brown" data-image="sneakers2.jpg"
          data-price="167">
          <div class="image-container">
            <img src="sneakers2.jpg" alt="Image2" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>AeroVoid Runners</h6>
                <p class="text-muted">Beige & Brown</p>
              </div>
              <h6>$167</h6>
            </div>
            <div class="button-group mt-3">
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="RetroGlide Sneakers" data-color="Green & White" data-image="sneakers3.jpg"
          data-price="173">
          <div class="image-container">
            <img src="sneakers3.jpg" alt="Image3" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>RetroGlide Sneakers</h6>
                <p class="text-muted">Green & White</p>
              </div>
              <h6>$173</h6>
            </div>
            <div class="button-group mt-3">
    ...
    <div class="row mt-4">
      <div class="col-md-4">
        <div class="product-box" data-name="CyberStride Sneakers" data-color="White & Gray" data-image="sneakers4.jpg"
          data-price="182">
          <div class="image-container">
            <img src="sneakers4.jpg" alt="Image4" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>CyberStride Sneakers</h6>
                <p class="text-muted">White & Gray</p>
              </div>
              <h6>$182</h6>
            </div>
            <div class="button-group mt-3">
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="PhantomAir Sneakers" data-color="Black & White" data-image="sneakers5.jpg"
          data-price="171">
          <div class="image-container">
            <img src="sneakers5.jpg" alt="Image5" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>PhantomAir Sneakers</h6>
                <p class="text-muted">Black & White</p>
              </div>
              <h6>$171</h6>
            </div>
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="ZeroGravity Sneakers" data-color="Beige & Cream" data-image="sneakers6.jpg"
          data-price="178">
          <div class="image-container">
            <img src="sneakers6.jpg" alt="Image6" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>ZeroGravity Sneakers</h6>
                <p class="text-muted">Beige & Cream</p>
              </div>
              <h6>$178</h6>
            </div>
            <div class="button-group mt-3">
