...
<head>
  ...
  <link rel="stylesheet" href="Dress Shoes page.css" />
...
<div class="content">
  <div class="header d-flex flex-column">
    <h6>Products</h6>
    <h2 style="font-weight: bold;">Dress Shoes</h2>
    <h4>Featured</h4>
  </div>
  ...
  <div class="products">
    <div class="row">
      <div class="col-md-4">
        <div class="product-box" data-name="MonarchLuxe Oxfords" data-color="Black" data-image="dressshoes1.jpg"
          data-price="190">
          <div class="image-container">
            <img src="dressshoes1.jpg" alt="Image1" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>MonarchLuxe Oxfords</h6>
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="CelestiForm Loafers" data-color="Black" data-image="dressshoes2.jpg"
          data-price="195">
          <div class="image-container">
            <img src="dressshoes2.jpg" alt="Image2" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="VelvetExecutive Derbies" data-color="Black" data-image="dressshoes3.jpg"
          data-price="173">
          <div class="image-container">
            <img src="dressshoes3.jpg" alt="Image3" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>VelvetExecutive Derbies</h6>
                <p class="text-muted">Black</p>
              </div>
              <h6>$173</h6>
            </div>
    ...
    <div class="row mt-4">
      <div class="col-md-4">
        <div class="product-box" data-name="OnyxSilk Dress Shoes" data-color="Black" data-image="dressshoes4.jpg"
          data-price="189">
          <div class="image-container">
            <img src="dressshoes4.jpg" alt="Image4" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>OnyxSilk Dress Shoes</h6>
                <p class="text-muted">Black</p>
              </div>
              <h6>$189</h6>
            </div>
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="NoirContour Wingtips" data-color="Black" data-image="dressshoes5.jpg"
          data-price="174">
          <div class="image-container">
            <img src="dressshoes5.jpg" alt="Image5" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>NoirContour Wingtips</h6>
                <p class="text-muted">Black</p>
              </div>
              <h6>$174</h6>
            </div>
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="AristoStep Slip-Ons" data-color="Brown" data-image="dressshoes6.jpg"
          data-price="179">
          <div class="image-container">
            <img src="dressshoes6.jpg" alt="Image6" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>AristoStep Slip-Ons</h6>
