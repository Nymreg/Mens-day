...
<head>
  ...
  <link rel="stylesheet" href="Slippers page.css" />
...
<div class="content">
  <div class="header d-flex flex-column">
    <h6>Products</h6>
    <h2 style="font-weight: bold;">Slippers</h2>
    <h4>Featured</h4>
  </div>
  ...
  <div class="products">
    <div class="row">
      <div class="col-md-4">
        <div class="product-box" data-name="CloudHush Slippers" data-color="Black & Gray" data-image="sliippers1.jpg"
          data-price="90">
          <div class="image-container">
            <img src="sliippers1.jpg" alt="Image1" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>CloudHush Slippers</h6>
                <p class="text-muted">Black & Gray</p>
              </div>
              <h6>$90</h6>
            </div>
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="LunaLoft Slippers" data-color="Brown" data-image="slippers2.jpg"
          data-price="85">
          <div class="image-container">
            <img src="slippers2.jpg" alt="Image2" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>LunaLoft Slippers</h6>
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="CocoonMoc Slippers" data-color="Brown" data-image="slippers3.jpg"
          data-price="87">
          <div class="image-container">
            <img src="slippers3.jpg" alt="Image3" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>CocoonMoc Slippers</h6>
                <p class="text-muted">Brown</p>
              </div>
              <h6>$87</h6>
            </div>
    ...
    <div class="row mt-4">
      <div class="col-md-4">
        <div class="product-box" data-name="SilkPuff Slides" data-color="Brown & Beige" data-image="slippers4.jpg"
          data-price="85">
          <div class="image-container">
            <img src="slippers4.jpg" alt="Image4" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>SilkPuff Slides</h6>
                <p class="text-muted">Brown & Beige</p>
              </div>
              <h6>$85</h6>
            </div>
            <div class="button-group mt-3">
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="VelvetDrift Slippers" data-color="Blue" data-image="slippers5.jpg"
          data-price="92">
          <div class="image-container">
            <img src="slippers5.jpg" alt="Image5" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>VelvetDrift Slippers</h6>
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="MarshmallowStep Slippers" data-color="Black & Gray"
          data-image="slippers6.jpg" data-price="87">
          <div class="image-container">
            <img src="slippers6.jpg" alt="Image6" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>MarshmallowStep Slippers</h6>
                <p class="text-muted">Black & Gray</p>
              </div>
              <h6>$87</h6>
            </div>
