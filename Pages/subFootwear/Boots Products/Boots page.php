...
<head>
  ...
  <link rel="stylesheet" href="Boots page.css" />
...
<div class="content">
  <div class="header d-flex flex-column">
    <h6>Products</h6>
    <h2 style="font-weight: bold;">Boots</h2>
    <h4>Featured</h4>
  </div>
  ...
  <div class="products">
    <div class="row">
      <div class="col-md-4">
        <div class="product-box" data-name="RogueTrek Boots" data-color="Black" data-image="boots1.jpg"
          data-price="189">
          <div class="image-container">
            <img src="boots1.jpg" alt="Image1" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>RogueTrek Boots</h6>
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="AshenDrift Boots" data-color="Brown" data-image="boots2.jpg"
          data-price="175">
          <div class="image-container">
            <img src="boots2.jpg" alt="Image2" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>AshenDrift Boots</h6>
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="VoidStride Combat Boots" data-color="Beige" data-image="boots3.jpg"
          data-price="193">
          <div class="image-container">
            <img src="boots3.jpg" alt="Image3" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>VoidStride Combat Boots</h6>
                <p class="text-muted">Beige</p>
              </div>
              <h6>$193</h6>
            </div>
            <div class="button-group mt-3">
    ...
    <div class="row mt-4">
      <div class="col-md-4">
        <div class="product-box" data-name="FrostBane Winter Boots" data-color="Yellow" data-image="boots4.jpg"
          data-price="165">
          <div class="image-container">
            <img src="boots4.jpg" alt="Image4" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>FrostBane Winter Boots</h6>
                <p class="text-muted">Yellow</p>
              </div>
              <h6>$165</h6>
            </div>
            <div class="button-group mt-3">
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="UrbanPioneer Boots" data-color="Brown" data-image="boots5.jpg"
          data-price="170">
          <div class="image-container">
            <img src="boots5.jpg" alt="Image5" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>UrbanPioneer Boots</h6>
                <p class="text-muted">Brown</p>
              </div>
              <h6>$170</h6>
            </div>
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="NebulaHike Boots" data-color="Black" data-image="boots6.jpg"
          data-price="163">
          <div class="image-container">
            <img src="boots6.jpg" alt="Image6" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>NebulaHike Boots</h6>
                <p class="text-muted">Black</p>
              </div>
              <h6>$163</h6>
            </div>
