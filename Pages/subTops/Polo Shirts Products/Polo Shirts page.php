...
<head>
  ...
  <link rel="stylesheet" href="Polo Shirts page.css" />
...
<body>
  ...
  <div class="content">
    <div class="header d-flex flex-column">
      <h6>Products</h6>
      <h2 style="font-weight: bold">Polo Shirts</h2>
      <h4>Featured</h4>
    </div>
    ...
    <div class="products">
      ...
      <div class="row">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="AeroStitch Polo" data-color="White and Maroon"
              data-image="poloshirt1.jpg" data-price="149">
              <div class="image-container">
                <img src="poloshirt1.jpg" alt="AeroStitch Polo" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>AeroStitch Polo</h6>
                    <p class="text-muted">White and Maroon</p>
                  </div>
                  <h6>$149</h6>
                </div>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="MonarchCrest Polo" data-color="Sap Green" data-image="poloshirt2.jpg"
              data-price="137">
              <div class="image-container">
                <img src="poloshirt2.jpg" alt="MonarchCrest Polo" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>MonarchCrest Polo</h6>
                    <p class="text-muted">Sap Green</p>
                  </div>
                  <h6>$137</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="NeonServe Polo" data-color="Mocha" data-image="poloshirt3.jpg"
              data-price="133">
              <div class="image-container">
                <img src="poloshirt3.jpg" alt="NeonServe Polo" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>NeonServe Polo</h6>
                    <p class="text-muted">Mocha</p>
                  </div>
                  <h6>$133</h6>
                </div>
                <div class="button-group mt-3">
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="SilkDrive Polo" data-color="Black" data-image="poloshirt4.jpg"
              data-price="145">
              <div class="image-container">
                <img src="poloshirt4.jpg" alt="SilkDrive Polo" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>SilkDrive Polo</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="RoguePiqué Polo" data-color="Charcoal Gray" data-image="poloshirt5.jpg"
              data-price="169">
              <div class="image-container">
                <img src="poloshirt5.jpg" alt="RoguePiqué Polo" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>RoguePiqué Polo</h6>
                    <p class="text-muted">Charcoal Gray</p>
                  </div>
                  <h6>$169</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="CosmoStripe Polo" data-color="French Beige" data-image="poloshirt6.jpg"
              data-price="153">
              <div class="image-container">
                <img src="poloshirt6.jpg" alt="CosmoStripe Polo" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>CosmoStripe Polo</h6>
                    <p class="text-muted">French Beige</p>
                  </div>
                  <h6>$153</h6>
                </div>
                <div class="button-group mt-3">
