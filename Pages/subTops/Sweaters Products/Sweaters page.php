...
<head>
  ...
  <link rel="stylesheet" href="Sweaters page.css" />
...
<body>
  ...
  <div class="content">
    <div class="header d-flex flex-column">
      <h6>Products</h6>
      <h2 style="font-weight: bold">Sweaters</h2>
      <h4>Featured</h4>
    </div>
    ...
    <div class="products">
      ...
      <div class="row">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="CloudKnit Sweater" data-color="Fuscous Grey" data-image="sweaters1.jpg"
              data-price="133">
              <div class="image-container">
                <img src="sweaters1.jpg" alt="CloudKnit Sweater" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>CloudKnit Sweater</h6>
                    <p class="text-muted">Fuscous Grey</p>
                  </div>
                  <h6>$133</h6>
                </div>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="RusticLoop Sweater" data-color="Ash Grey" data-image="sweaters2.jpg"
              data-price="141">
              <div class="image-container">
                <img src="sweaters2.jpg" alt="RusticLoop Sweater" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>RusticLoop Sweater</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="OnyxCable Sweater" data-color="Gable Green" data-image="sweaters3.jpg"
              data-price="153">
              <div class="image-container">
                <img src="sweaters3.jpg" alt="OnyxCable Sweater" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>OnyxCable Sweater</h6>
                    <p class="text-muted">Gable Green</p>
                  </div>
                  <h6>$153</h6>
                </div>
                <div class="button-group mt-3">
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="LuxeSlouch Sweater" data-color="Dark" data-image="sweaters4.jpg"
              data-price="155">
              <div class="image-container">
                <img src="sweaters4.jpg" alt="LuxeSlouch Sweater" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>LuxeSlouch Sweater</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="FrostWeave Sweater" data-color="White Rock" data-image="sweaters5.jpg"
              data-price="143">
              <div class="image-container">
                <img src="sweaters5.jpg" alt="FrostWeave Sweater" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>FrostWeave Sweater</h6>
                    <p class="text-muted">White Rock</p>
                  </div>
                  <h6>$143</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="NomadWool Sweater" data-color="StarDust" data-image="sweaters6.jpg"
              data-price="137">
              <div class="image-container">
                <img src="sweaters6.jpg" alt="NomadWool Sweater" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>NomadWool Sweater –</h6>
                    <p class="text-muted">StarDust</p>
                  </div>
                  <h6>$137</h6>
                </div>
                <div class="button-group mt-3">
