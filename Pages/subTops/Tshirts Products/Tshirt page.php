...
<head>
  ...
  <link rel="stylesheet" href="Tshirt page.css" />
...
<body>
  ...
  <div class="content">
    ...
    <div class="products">
      ...
      <div class="row">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="RetroGlow Tee" data-color="Mirage" data-image="tshirt1.jpg"
              data-price="163">
              <div class="image-container">
                <img src="tshirt1.jpg" alt="Wool Cardigan" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>RetroGlow Tee</h6>
                    <p class="text-muted">Mirage</p>
                  </div>
                  <h6>$138</h6>
                </div>
                <div class="button-group mt-3">
                  <button class="btn btn-add-to-cart btn-sm w-100 mb-2">
                    Add to Cart
                  </button>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="SilkBlend Tee" data-color="Sorell Brown" data-image="tshirt2.jpg"
              data-price="162">
              <div class="image-container">
                <img src="tshirt2.jpg" alt="SilkBlend Tee" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>SilkBlend Tee</h6>
                    <p class="text-muted">Sorell Brown</p>
                  </div>
                  <h6>$162</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="RogueInk Tee" data-color="Mid Grey" data-image="tshirt3.jpg"
              data-price="163">
              <div class="image-container">
                <img src="tshirt3.jpg" alt="RogueInk Tee" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>RogueInk Tee</h6>
                    <p class="text-muted">Mid Grey</p>
                  </div>
                  <h6>$163</h6>
                </div>
                <div class="button-group mt-3">
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="EchoPalm Tee" data-color="Woody Brown" data-image="tshirt4.jpg"
              data-price="154">
              <div class="image-container">
                <img src="tshirt4.jpg" alt="EchoPalm Tee" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>EchoPalm Tee</h6>
                    <p class="text-muted">Woody Brown</p>
                  </div>
                  <h6>$154</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="PhantomFit Tee" data-color="Double Spanish White"
              data-image="tshirt5.jpg" data-price="160">
              <div class="image-container">
                <img src="tshirt5.jpg" alt="PhantomFit Tee" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>PhantomFit Tee</h6>
                    <p class="text-muted">Double Spanish White</p>
                  </div>
                  <h6>$160</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="AeroCotton Tee" data-color="Vanilla" data-image="tshirt6.jpg"
              data-price="173">
              <div class="image-container">
                <img src="tshirt6.jpg" alt="AeroCotton Tee" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>AeroCotton Tee</h6>
      ...
      <div class="cart-modal-footer">
        <div class="cart-coupon-row" style="display: flex; gap: 8px; margin-bottom: 15px">
          <input type="text" id="cartCouponInput" class="form-control" placeholder="Enter coupon code"
            style="flex: 1" />
          <button id="applyCouponBtn" class="btn" type="button" style="background-color: black; color: white">
            Apply Coupon
          </button>
        </div>
        <div id="cartCouponMsg" style="
              min-height: 22px;
              font-size: 0.95em;
              color: #2d7a2d;
              margin-bottom: 10px;
  ...
  <script>
    ...
    document.body.addEventListener("click", function (e) {
      ...
      if (!name)
        name = productBox.querySelector("h6")?.textContent.trim() || "";
      if (!color)
        color =
          productBox.querySelector(".text-muted")?.textContent.trim() || "";
      if (!image)
        image = productBox.querySelector("img")?.getAttribute("src") || "";
      if (!price) {
        let priceText = productBox
          .querySelector(".d-flex h6:last-child")
        ...
        div.innerHTML = `
            ...
            <div class="cart-item-details">
              ...
              <div class="cart-item-pricing">
                <span class="cart-item-linetotal">$${(
            item.price * item.qty
          ).toFixed(2)}</span>
              </div>
