...
<head>
  ...
  <link rel="stylesheet" href="Shirts page.css" />
...
<body>
  ...
  <div class="content">
    <div class="header d-flex flex-column">
      <h6>Products</h6>
      <h2 style="font-weight: bold">Shirts</h2>
      <h4>Featured</h4>
    </div>
    ...
    <div class="products">
      ...
      <div class="row">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="LinenHaze Shirt" data-color="Black" data-image="shirt1.jpg"
              data-price="42">
              <div class="image-container">
                <img src="shirt1.jpg" alt="LinenHaze Shirt" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>LinenHaze Shirt</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="GrindForm Shirt" data-color="Tealish Blue" data-image="shirt2.jpg"
              data-price="39">
              <div class="image-container">
                <img src="shirt2.jpg" alt="GrindForm Shirt" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>GridForm Shirt</h6>
                    <p class="text-muted">Tealish Blue</p>
                  </div>
                  <h6>$39</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="NoirPleat Shirt" data-color="Light Taupe" data-image="shirt3.jpg"
              data-price="47">
              <div class="image-container">
                <img src="shirt3.jpg" alt="NoirPleat Shirt" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>NoirPleat Shirt</h6>
                    <p class="text-muted">Light Taupe</p>
                  </div>
                  <h6>$47</h6>
                </div>
                <div class="button-group mt-3">
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="DriftWave Shirt" data-color="Grey Olive" data-image="shirt4.jpg"
              data-price="35">
              <div class="image-container">
                <img src="shirt4.jpg" alt="DriftWave Shirt" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>DriftWave Shirt</h6>
                    <p class="text-muted">Grey Olive</p>
                  </div>
                  <h6>$35</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="ApexCollar Shirt" data-color="Satin Linen" data-image="shirt5.jpg"
              data-price="47">
              <div class="image-container">
                <img src="shirt5.jpg" alt="ApexCollar Shirt" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>ApexCollar Shirt</h6>
                    <p class="text-muted">Satin Linen</p>
                  </div>
                  <h6>$47</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="VoidTuck Shirt" data-color="Smoky Black" data-image="shirt6.jpg"
              data-price="52">
              <div class="image-container">
                <img src="shirt6.jpg" alt="VoidTuck Shirt" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>VoidTuck Shirt</h6>
                    <p class="text-muted">Smoky Black</p>
                  </div>
                  <h6>$52</h6>
                </div>
                <div class="button-group mt-3">
