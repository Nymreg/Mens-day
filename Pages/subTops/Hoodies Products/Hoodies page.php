...
<head>
  ...
  <link rel="stylesheet" href="Hoodies page.css" />
...
<body>
  ...
  <div class="content">
    <div class="header d-flex flex-column">
      <h6>Products</h6>
      <h2 style="font-weight: bold;">Hoodies</h2>
      <h4>Featured</h4>
    </div>
    ...
    <div class="products">
      <div class="row">
        <div class="col-md-4">
          <a href="../../Product Detail Page/ProDet.php" class="product-link">
            <div class="product-box" data-name="ShadowLoom Hoodie" data-color="Retro" data-image="hoodies1.jpg"
              data-price="169">
              <div class="image-container">
                <img src="hoodies1.jpg" alt="ShadowLoom Hoodie" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>ShadowLoom Hoodie</h6>
                    <p class="text-muted">Retro</p>
                  </div>
                  <h6>$169</h6>
                </div>
        ...
        <div class="col-md-4">
          <div class="product-box" data-name="VoidPuff Hoodie" data-color="White and Purple" data-image="hoodies2.jpg"
            data-price="169">
            <div class="image-container">
              <img src="hoodies2.jpg" alt="VoidPuff Hoodie" class="img-fluid" />
            </div>
            <div class="product-details">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h6>VoidPuff Hoodie</h6>
                  <p class="text-muted">White and Purple</p>
                </div>
                <h6>$169</h6>
              </div>
              <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          ...
          <div class="product-box" data-name="RiotFleece Hoodie" data-color="White and Green" data-image="hoodies3.jpg"
            data-price="184">
            <div class="image-container">
              <img src="hoodies3.jpg" alt="RiotFleece Hoodie" class="img-fluid" />
            </div>
            <div class="product-details">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h6>RiotFleece Hoodie</h6>
                  <p class="text-muted">White and Green</p>
                </div>
                <h6>$184</h6>
              </div>
              <div class="button-group mt-3">
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          ...
          <div class="product-box" data-name="NebulaPull Hoodie" data-color="Gray and Black" data-image="hoodies4.jpg"
            data-price="177">
            <div class="image-container">
              <img src="hoodies4.jpg" alt="NebulaPull Hoodie" class="img-fluid" />
            </div>
            <div class="product-details">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h6>NebulaPull Hoodie</h6>
                  <p class="text-muted">Gray and Black</p>
                </div>
                <h6>$177</h6>
              </div>
              <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          ...
          <div class="product-box" data-name="UrbanCocoon Hoodie" data-color="Retro gray" data-image="hoodies5.jpg"
            data-price="167">
            <div class="image-container">
              <img src="hoodies5.jpg" alt="UrbanCocoon Hoodie" class="img-fluid" />
            </div>
            <div class="product-details">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h6>UrbanCocoon Hoodie</h6>
                  <p class="text-muted">Retro gray</p>
                </div>
                <h6>$167</h6>
              </div>
              <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          ...
          <div class="product-box" data-name="StealthSlouch Hoodie" data-color="Retro Blue" data-image="hoodies6.jpg"
            data-price="189">
            <div class="image-container">
              <img src="hoodies6.jpg" alt="StealthSlouch Hoodie" class="img-fluid" />
            </div>
            <div class="product-details">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h6>StealthSlouch Hoodie</h6>
                  <p class="text-muted">Retro Blue</p>
                </div>
                <h6>$189</h6>
              </div>
              <div class="button-group mt-3">
