...
<head>
  ...
  <link rel="stylesheet" href="Trouser page.css" />
...
<body>
  ...
  <div class="content">
    <div class="header d-flex flex-column">
      <h6>Products</h6>
      <h2 style="font-weight: bold">Trousers</h2>
      <h4>Featured</h4>
    </div>
    ...
    <div class="products">
      ...
      <div class="row">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="ExecutiveEdge Trousers" data-color="Woodsmoke" data-image="trouser1.jpg"
              data-price="142">
              <div class="image-container">
                <img src="trouser1.jpg" alt="ExecutiveEdge Trousers" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>ExecutiveEdge Trousers</h6>
                    <p class="text-muted">Woodsmoke</p>
                  </div>
                  <h6>$142</h6>
                </div>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="MetroPleat Trousers" data-color="Pastel Grey" data-image="trouser2.jpg"
              data-price="150">
              <div class="image-container">
                <img src="trouser2.jpg" alt="MetroPleat Trousers" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>MetroPleat Trousers</h6>
                    <p class="text-muted">Pastel Grey</p>
                  </div>
                  <h6>$150</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="PrestigeLine Trousers" data-color="Pastel Brown"
              data-image="trouser3.jpg" data-price="123">
              <div class="image-container">
                <img src="trouser3.jpg" alt="PrestigeLine Trousers" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>PrestigeLine Trousers</h6>
                    <p class="text-muted">Pastel Brown</p>
                  </div>
                  <h6>$123</h6>
                </div>
                <div class="button-group mt-3">
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="FormaFit Trousers" data-color="Dark" data-image="trouser4.jpg"
              data-price="175">
              <div class="image-container">
                <img src="trouser4.jpg" alt="FormaFit Trousers" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>FormaFit Trousers</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="VentureTailored Trousers" data-color="Slate Blue"
              data-image="trouser5.jpg" data-price="100">
              <div class="image-container">
                <img src="trouser5.jpg" alt="VentureTailored Trousers" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>VentureTailored Trousers</h6>
                    <p class="text-muted">Slate Blue</p>
                  </div>
                  <h6>$100</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="UrbanPace Trousers" data-color="Dark Taupe" data-image="trouser6.jpg"
              data-price="136">
              <div class="image-container">
                <img src="trouser6.jpg" alt="UrbanPace Trousers" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>UrbanPace Trousers</h6>
                    <p class="text-muted">Dark Taupe</p>
                  </div>
                  <h6>$136</h6>
                </div>
                <div class="button-group mt-3">
