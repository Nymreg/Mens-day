...
<head>
  ...
  <link rel="stylesheet" href="Sweatpants page.css" />
...
<body>
  ...
  <div class="content">
    <div class="header d-flex flex-column">
      <h6>Products</h6>
      <h2 style="font-weight: bold;">Sweatpants</h2>
      <h4>Featured</h4>
    </div>
    ...
    <div class="products">
      ...
      <div class="row">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="CloudLuxe Sweatpants" data-color="French Grey"
              data-image="sweatpants1.jpg" data-price="120">
              <div class="image-container">
                <img src="sweatpants1.jpg" alt="CloudLuxe Sweatpants" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>CloudLuxe Sweatpants</h6>
                    <p class="text-muted">French Grey</p>
                  </div>
                  <h6>$120</h6>
                </div>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="ZenithComfort Sweatpants" data-color="Charcoal"
              data-image="sweatpants2.jpg" data-price="127">
              <div class="image-container">
                <img src="sweatpants2.jpg" alt="ZenithComfort Sweatpants" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>ZenithComfort Sweatpants</h6>
                    <p class="text-muted">Charcoal</p>
                  </div>
                  <h6>$127</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="Eclipse Relaxed Fit" data-color="Ash Grey" data-image="sweatpants3.jpg"
              data-price="141">
              <div class="image-container">
                <img src="sweatpants3.jpg" alt="Eclipse Relaxed Fit" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>Eclipse Relaxed Fit/h6>
                      <p class="text-muted">Ash Grey</p>
                  </div>
                  <h6>$141</h6>
                </div>
                <div class="button-group mt-3">
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="LoftVibe Sweatpants" data-color="Dawn" data-image="sweatpants4.jpg"
              data-price="148">
              <div class="image-container">
                <img src="sweatpants4.jpg" alt="Fourth Top" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>LoftVibe Sweatpants</h6>
                    <p class="text-muted">Dawn</p>
                  </div>
                  <h6>$148</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="AeroSoft Sweatpants" data-color="Granite" data-image="sweatpants5.jpg"
              data-price="169">
              <div class="image-container">
                <img src="sweatpants5.jpg" alt="AeroSoft Sweatpants" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>AeroSoft Sweatpants</h6>
                    <p class="text-muted">Granite</p>
                  </div>
                  <h6>$169</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="TerraCush Sweatpants" data-color="Dirty Purple"
              data-image="sweatpants6.jpg" data-price="119">
              <div class="image-container">
                <img src="sweatpants6.jpg" alt="TerraCush Sweatpants" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>TerraCush Sweatpants</h6>
                    <p class="text-muted">Dirty Purple</p>
                  </div>
                  <h6>$119</h6>
                </div>
                <div class="button-group mt-3">
