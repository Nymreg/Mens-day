...
<head>
  ...
  <link rel="stylesheet" href="Shorts page.css" />
...
<body>
  ...
  <div class="content">
    <div class="header d-flex flex-column">
      <h6>Products</h6>
      <h2 style="font-weight: bold">Shorts</h2>
      <h4>Featured</h4>
    </div>
    ...
    <div class="products">
      ...
      <div class="row">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="BreezeCraft Shorts" data-color="Dark" data-image="shorts1.jpg"
              data-price="76">
              <div class="image-container">
                <img src="shorts1.jpg" alt="BreezeCraft Shorts" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>BreezeCraft Shorts</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="SummitAir Shorts" data-color="Night" data-image="shorts2.jpg"
              data-price="60">
              <div class="image-container">
                <img src="shorts2.jpg" alt="SummitAir Shorts" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>SummitAir Shorts</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="CoastalDrift Shorts" data-color="Storm Grey" data-image="shorts3.jpg"
              data-price="83">
              <div class="image-container">
                <img src="shorts3.jpg" alt="CoastalDrift Shorts" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>CoastalDrift Shorts</h6>
                    <p class="text-muted">Storm Grey</p>
                  </div>
                  <h6>$83</h6>
                </div>
                <div class="button-group mt-3">
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="HorizonLine Shorts" data-color="Pastel Grey" data-image="shorts4.jpg"
              data-price="77">
              <div class="image-container">
                <img src="shorts4.jpg" alt="HorizonLine Shorts" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>HorizonLine Shorts</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="Solaris Shorts" data-color="Tan" data-image="shorts5.jpg"
              data-price="64">
              <div class="image-container">
                <img src="shorts5.jpg" alt="Solaris Shorts" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>Solaris Shorts</h6>
                    <p class="text-muted">Tan</p>
                  </div>
                  <h6>$64</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="PollaVoid Shorts" data-color="Camouflage Green" data-image="shorts6.jpg"
              data-price="66">
              <div class="image-container">
                <img src="shorts6.jpg" alt="PollaVoid Shorts" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>PollaVoid Shorts</h6>
