...
<head>
  ...
  <link rel="stylesheet" href="Jeans page.css" />
...
<body>
  ...
  <div class="content">
    <div class="header d-flex flex-column">
      <h6>Products</h6>
      <h2 style="font-weight: bold">Jeans</h2>
      <h4>Featured</h4>
    </div>
    ...
    <div class="products">
      ...
      <div class="row">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="Distressed Denim Jeans" data-color="Oslo Grey" data-image="jeans1.jpg"
              data-price="188">
              <div class="image-container">
                <img src="jeans1.jpg" alt="Distressed Denim Jeans" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>Distressed Denim Jeans</h6>
                    <p class="text-muted">Oslo Grey</p>
                  </div>
                  <h6>$188</h6>
                </div>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="Slim Fit Blue Jeans" data-color="Marble Blue" data-image="jeans2.jpg"
              data-price="150">
              <div class="image-container">
                <img src="jeans2.jpg" alt="Slim Fit Blue Jeans" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>Slim Fit Blue Jeans</h6>
                    <p class="text-muted">Marble Blue</p>
                  </div>
                  <h6>$150</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="Stretch Black Jeans" data-color="Smoky Black" data-image="jeans3.jpg"
              data-price="113">
              <div class="image-container">
                <img src="jeans3.jpg" alt="Stretch Black Jeans" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>Stretch Black Jeans</h6>
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="Denim Jeans" data-color="Taupe" data-image="jeans4.jpg"
              data-price="150">
              <div class="image-container">
                <img src="jeans4.jpg" alt="Denim Jeans" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>Denim Jeans</h6>
                    <p class="text-muted">Taupe</p>
                  </div>
                  <h6>$105</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="VintageVibe Jeans" data-color="Davy Grey" data-image="jeans5.jpg"
              data-price="190">
              <div class="image-container">
                <img src="jeans5.jpg" alt="VintageVibe Jeans" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>VintageVibe Jeans</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="Sovereign Jeans" data-color="Gravel" data-image="jeans6.jpg"
              data-price="150">
              <div class="image-container">
                <img src="jeans6.jpg" alt="Sovereign Jeans" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>Sovereign Denim</h6>
                    <p class="text-muted">Gravek</p>
                  </div>
                  <h6>$126</h6>
                </div>
                <div class="button-group mt-3">
