...
<head>
  ...
  <link rel="stylesheet" href="Chinos page.css" />
...
<body>
  ...
  <div class="content">
    <div class="header d-flex flex-column">
      <h6>Products</h6>
      <h2 style="font-weight: bold">Chinos</h2>
      <h4>Featured</h4>
    </div>
    ...
    <div class="products">
      ...
      <div class="row">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="UrbanFlex Chinos" data-color="Rosy Brown" data-image="chino1.jpg"
              data-price="158">
              <div class="image-container">
                <img src="chino1.jpg" alt="UrbanFlex Chinos" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>UrbanFlex Chinos</h6>
                    <p class="text-muted">Rosy Brown</p>
                  </div>
                  <h6>$158</h6>
                </div>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="ClassicAire Chinos" data-color="Vanilla" data-image="chino2.jpg"
              data-price="140">
              <div class="image-container">
                <img src="chino2.jpg" alt="ClassicAire Chinos class=" img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>ClassicAire Chinos</h6>
                    <p class="text-muted">Vanilla</p>
                  </div>
                  <h6>$140</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="Voyager Slim Chinos" data-color="Mocha" data-image="chino3.jpg"
              data-price="141">
              <div class="image-container">
                <img src="chino3.jpg" alt="Voyager Slim Chinos" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>Voyager Slim Chinos</h6>
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="EliteStride Chinos" data-color="Dull Brown" data-image="chino4.jpg"
              data-price="175">
              <div class="image-container">
                <img src="chino4.jpg" alt="Fourth Top" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>EliteStride Chinos</h6>
                    <p class="text-muted">Dull Brown</p>
                  </div>
                  <h6>$175</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="PrimeCrest Chinos" data-color="Dawn" data-image="chino5.jpg"
              data-price="133">
              <div class="image-container">
                <img src="chino5.jpg" alt="PrimeCrest Chinos" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>PrimeCrest Chinos</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="Terraneo Chinos" data-color="Dark Grey" data-image="chino6.jpg"
              data-price="136">
              <div class="image-container">
                <img src="chino6.jpg" alt="Terraneo Chinos" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>Terraneo Chinos</h6>
