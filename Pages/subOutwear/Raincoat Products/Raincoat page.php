...
<head>
  ...
  <link rel="stylesheet" href="Raincoat page.css" />
...
<body>
  ...
  <div class="content">
    <div class="header d-flex flex-column">
      <h6>Products</h6>
      <h2 style="font-weight: bold">Raincoats</h2>
      <h4>Featured</h4>
    </div>
    ...
    <div class="products">
      ...
      <div class="row">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="StormPhantom Raincoat" data-color="Dark Grey" data-image="raincoat1.jpg"
              data-price="88">
              <div class="image-container">
                <img src="raincoat1.jpg" alt="StormPhantom Raincoat" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>StormPhantom Raincoat</h6>
                    <p class="text-muted">Dark Grey</p>
                  </div>
                  <h6>$88</h6>
                </div>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="AquaVex Rain Shell" data-color="Camouflage Green"
              data-image="raincoat2.jpg" data-price="40">
              <div class="image-container">
                <img src="raincoat2.jpg" alt="AquaVex Rain Shell" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>AquaVex Rain Shell</h6>
                    <p class="text-muted">Camouflage Green</p>
                  </div>
                  <h6>$40</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="NeonDrizzle Coat" data-color="Night" data-image="raincoat3.jpg"
              data-price="48">
              <div class="image-container">
                <img src="raincoat3.jpg" alt="NeonDrizzle Coat" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>NeonDrizzle Coat</h6>
                    <p class="text-muted">Night</p>
                  </div>
                  <h6>$48</h6>
                </div>
                <div class="button-group mt-3">
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="HydroBloc Raincoat" data-color="Pacific Blue" data-image="raincoat4.jpg"
              data-price="57">
              <div class="image-container">
                <img src="raincoat4.jpg" alt="HydroBloc Raincoat" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>HydroBloc Raincoat</h6>
                    <p class="text-muted">Pacific Blue</p>
                  </div>
                  <h6>$57</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="TyphoonTrek Coat" data-color="Gravel" data-image="raincoat5.jpg"
              data-price="70">
              <div class="image-container">
                <img src="raincoat5.jpg" alt="TyphoonTrek Coat" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>TyphoonTrek Coat</h6>
                    <p class="text-muted">Gravel</p>
                  </div>
                  <h6>$70</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="EchoShield Rainwear" data-color="Dusty Orange"
              data-image="raincoat6.jpg" data-price="49">
              <div class="image-container">
                <img src="raincoat6.jpg" alt="EchoShield Rainwear" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>EchoShield Rainwear</h6>
                    <p class="text-muted">Dusty Orange</p>
                  </div>
                  <h6>$49</h6>
                </div>
                <div class="button-group mt-3">
