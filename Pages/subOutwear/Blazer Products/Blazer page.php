...
<head>
  ...
  <link rel="stylesheet" href="Blazer page.css" />
...
<body>
  ...
  <div class="content">
    <div class="header d-flex flex-column">
      <h6>Products</h6>
      <h2 style="font-weight: bold">Blazers</h2>
      <h4>Featured</h4>
    </div>
    ...
    <div class="products">
      ...
      <div class="row">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="NeoForm Blazer" data-color="Mirage" data-image="blazer1.jpg"
              data-price="188">
              <div class="image-container">
                <img src="blazer1.jpg" alt="NeoForm Blazer" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>NeoForm Blazer</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="ApexEdge Blazer" data-color="Night" data-image="blazer2.jpg"
              data-price="150">
              <div class="image-container">
                <img src="blazer2.jpg" alt="ApexEdge Blazer" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>ApexEdge Blazer</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="ModaVogue Blazer" data-color="English Walnut" data-image="blazer3.jpg"
              data-price="213">
              <div class="image-container">
                <img src="blazer3.jpg" alt="ModaVogue Blazer" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>ModaVogue Blazer</h6>
                    <p class="text-muted">English Walnut</p>
                  </div>
                  <h6>$213</h6>
                </div>
                <div class="button-group mt-3">
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="LuxeNomad Blazer" data-color="Mirage" data-image="blazer4.jpg"
              data-price="225">
              <div class="image-container">
                <img src="blazer4.jpg" alt="LuxeNomad" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>LuxeNomad Blazer</h6>
                    <p class="text-muted">Mirage</p>
                  </div>
                  <h6>$225</h6>
                </div>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="Void & Structure Blazer" data-color="Onyx" data-image="blazer5.jpg"
              data-price="299">
              <div class="image-container">
                <img src="blazer5.jpg" alt="Void & Structure Blazer" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>Void & Structure Blazer</h6>
                    <p class="text-muted">Onyx</p>
                  </div>
                  <h6>$299</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="MetroSleek Blazer" data-color="Charcoal" data-image="blazer6.jpg"
              data-price="345">
              <div class="image-container">
                <img src="blazer6.jpg" alt="MetroSleek Blazer" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>MetroSleek Blazer</h6>
