...
<head>
  ...
  <link rel="stylesheet" href="Coats page.css" />
...
<body>
  ...
  <div class="content">
    <div class="header d-flex flex-column">
      <h6>Products</h6>
      <h2 style="font-weight: bold;">Coats</h2>
      <h4>Featured</h4>
    </div>
    ...
    <div class="products">
      ...
      <div class="row">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="Frostine Overcoat" data-color="Dark" data-image="coats1.jpg"
              data-price="298">
              <div class="image-container">
                <img src="coats1.jpg" alt="Frostine Overcoat" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>Frostine Overcoat</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="UrbanTherm Coat" data-color="Smoky Black" data-image="coats2.jpg"
              data-price="190">
              <div class="image-container">
                <img src="coats2.jpg" alt="UrbanTherm Coat" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>UrbanTherm Coat</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="NoirShield Long Coat" data-color="Wood Smoke" data-image="coats3.jpg"
              data-price="210">
              <div class="image-container">
                <img src="coats3.jpg" alt="NoirShield Long Coat" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>NoirShield Long Coat</h6>
                    <p class="text-muted">Wood Smoke</p>
                  </div>
                  <h6>$210</h6>
                </div>
                <div class="button-group mt-3">
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="AetherWrap Coat" data-color="Flint" data-image="coats4.jpg"
              data-price="175">
              <div class="image-container">
                <img src="coats4.jpg" alt="AetherWrap Coat" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>AetherWrap Coat</h6>
                    <p class="text-muted">Flint</p>
                  </div>
                  <h6>$175</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="GlacierForm Coat" data-color="Eclipse" data-image="coats5.jpg"
              data-price="222">
              <div class="image-container">
                <img src="coats5.jpg" alt="GlacierForm Coat" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>GlacierForm Coat</h6>
                    <p class="text-muted">Eclipse</p>
                  </div>
                  <h6>$222</h6>
                </div>
                <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="MoodVoir Coat " data-color="Coffee Bean" data-image="coats6.jpg"
              data-price="336">
              <div class="image-container">
                <img src="coats6.jpg" alt="Sixth Top" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>MoodVoir Coat</h6>
                    <p class="text-muted">Coffee Bean</p>
                  </div>
                  <h6>$336</h6>
                </div>
                <div class="button-group mt-3">
