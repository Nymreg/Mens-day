...
<head>
  ...
  <link rel="stylesheet" href="Jackets page.css" />
...
<body>
  ...
  <div class="content">
    <div class="header d-flex flex-column">
      <h6>Products</h6>
      <h2 style="font-weight: bold">Jackets</h2>
      <h4>Featured</h4>
    </div>
    ...
    <div class="products">
      ...
      <div class="row">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="RiotBomber Jacket" data-color="Black Cat" data-image="jacket1.jpg"
              data-price="168">
              <div class="image-container">
                <img src="jacket1.jpg" alt="RiotBomber Jacket" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>RiotBomber Jacket</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="VentureX Jacket" data-color="Mirage" data-image="jacket2.jpg"
              data-price="150">
              <div class="image-container">
                <img src="jacket2.jpg" alt="VentureX Jacket" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>VentureX Jacket</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="CyberPuff Jacket" data-color="Heavy Metal" data-image="jacket3.jpg"
              data-price="163">
              <div class="image-container">
                <img src="jacket3.jpg" alt="CyberPuff Jacket" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>CyberPuff Jacket</h6>
                    <p class="text-muted">Heavy Metal</p>
                  </div>
                  <h6>$163</h6>
                </div>
                <div class="button-group mt-3">
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="StealthMode Jacket" data-color="Gravel" data-image="jacket4.jpg"
              data-price="175">
              <div class="image-container">
                <img src="jacket4.jpg" alt="StealthMode Jacket" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>StealthMode Jacket</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="AeroRush Jacket" data-color="Dark" data-image="jacket5.jpg"
              data-price="160">
              <div class="image-container">
                <img src="jacket5.jpg" alt="AeroRush Jacket class=" img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>AeroRush Jacket</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="NebulaQuilt Jacket" data-color="Vanilla Ice" data-image="jacket6.jpg"
              data-price="236">
              <div class="image-container">
                <img src="jacket6.jpg" alt="NebulaQuilt Jacket" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>NebulaQuilt Jacket</h6>
                    <p class="text-muted">Vanilla Ice</p>
                  </div>
                  <h6>$236</h6>
                </div>
                <div class="button-group mt-3">
