...
<head>
  ...
  <link rel="stylesheet" href="Vest page.css" />
...
<body>
  ...
  <div class="content">
    <div class="header d-flex flex-column">
      <h6>Products</h6>
      <h2 style="font-weight: bold">Vest's</h2>
      <h4>Featured</h4>
    </div>
    ...
    <div class="products">
      ...
      <div class="row">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="QuantumPuff Vest" data-color="Charcoal" data-image="vest1.jpg"
              data-price="140">
              <div class="image-container">
                <img src="vest1.jpg" alt="QuantumPuff Vest" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>QuantumPuff Vest</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="GridLock Vest" data-color="Miragel" data-image="vest2.jpg"
              data-price="155">
              <div class="image-container">
                <img src="vest2.jpg" alt="GridLock Vest" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="UrbanTherm Vest" data-color="Tobacco Brown" data-image="vest3.jpg"
              data-price="163">
              <div class="image-container">
                <img src="vest3.jpg" alt="UrbanTherm Vest" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>UrbanThermo Vest</h6>
                    <p class="text-muted">Tobacco Brown</p>
                  </div>
                  <h6>$163</h6>
                </div>
                <div class="button-group mt-3">
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="NomadCore Vest" data-color="Dark" data-image="vest4.jpg"
              data-price="135">
              <div class="image-container">
                <img src="vest4.jpg" alt="NomadCore Vest" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>NomadCore Vest</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="AeroFleece Vest" data-color="Night" data-image="vest5.jpg"
              data-price="160">
              <div class="image-container">
                <img src="vest5.jpg" alt="AeroFleece Vest" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>AeroFleece Vest</h6>
        ...
        <div class="col-md-4">
          <a href="">
            <div class="product-box" data-name="ZeroG Vest" data-color="Charcoal" data-image="vest6.jpg"
              data-price="159">
              <div class="image-container">
                <img src="vest6.jpg" alt="Sixth Top" class="img-fluid" />
              </div>
              <div class="product-details">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6>ZeroG Vest</h6>
                    <p class="text-muted">Bleached Cedar</p>
                  </div>
                  <h6>$159</h6>
                </div>
                <div class="button-group mt-3">
