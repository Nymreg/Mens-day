...
<head>
  ...
  <link rel="stylesheet" href="Belts styles.css" />
...
<body>
  ...
  <div class="content">
    <div class="header d-flex flex-column">
      <h6>Products</h6>
      <h2 style="font-weight: bold;">Belts</h2>
      <h4>Featured</h4>
    </div>
    ...
    <div class="products">
      <div class="row">
        <div class="col-md-4">
          <div class="product-box" data-name="Leather Belt" data-color="Black" data-image="belt1.jpg" data-price="28">
            <div class="image-container">
              <img src="belt1.jpg" alt="Image1" class="img-fluid" />
            </div>
        ...
        <div class="col-md-4">
          <div class="product-box" data-name="Braided Belt" data-color="Brown" data-image="belt2.avif" data-price="10">
            <div class="image-container">
              <img src="braided.jpg" alt="Image2" class="img-fluid" />
            </div>
            <div class="product-details">
              <div class="d-flex justify-content-between align-items-center"
                style="display:flex;justify-content:space-between;align-items:center;">
        ...
        <div class="col-md-4">
          <div class="product-box" data-name="Tactical Duty Belt" data-color="Black" data-image="belt3.jpg"
            data-price="30">
            <div class="image-container">
              <img src="belt3.jpg" alt="Image3" class="img-fluid" />
            </div>
            <div class="product-details">
              <div class="d-flex justify-content-between align-items-center"
                style="display:flex;justify-content:space-between;align-items:center;">
                <div>
                  <h6>Tactical Duty Belt</h6>
                  <p class="text-muted">Black</p>
                </div>
                <h6>$30</h6>
              </div>
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <div class="product-box" data-name="Suede Belt" data-color="Dark Brown" data-image="belt4.jpg"
            data-price="35">
            <div class="image-container">
              <img src="belt4.jpg" alt="Image4" class="img-fluid" />
            </div>
            <div class="product-details">
              <div class="d-flex justify-content-between align-items-center"
                style="display:flex;justify-content:space-between;align-items:center;">
                <div>
                  <h6>Suede Belt</h6>
                  <p class="text-muted">Dark Brown</p>
                </div>
                <h6>$35</h6>
              </div>
              <div class="button-group mt-3">
        ...
        <div class="col-md-4">
          <div class="product-box" data-name="Nylon Belt" data-color="Grey" data-image="belt5.jpg" data-price="70">
            <div class="image-container">
              <img src="belt5.jpg" alt="Image5" class="img-fluid" />
            </div>
            <div class="product-details">
              <div class="d-flex justify-content-between align-items-center"
                style="display:flex;justify-content:space-between;align-items:center;">
        ...
        <div class="col-md-4">
          <div class="product-box" data-name="Webbing Belt" data-color="Blue" data-image="belt6.jpg" data-price="45">
            <div class="image-container">
              <img src="belt6.jpg" alt="Image6" class="img-fluid" />
            </div>
            <div class="product-details">
              <div class="d-flex justify-content-between align-items-center"
                style="display:flex;justify-content:space-between;align-items:center;">
