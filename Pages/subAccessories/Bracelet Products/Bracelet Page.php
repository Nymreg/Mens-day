...
<head>
  ...
  <link rel="stylesheet" href="Bracelet Page.css" />
...
<div class="content">
  <div class="header d-flex flex-column">
    <h6>Products</h6>
    <h2 style="font-weight: bold;">Bracelets</h2>
    <h4>Featured</h4>
  </div>
  ...
  <div class="products">
    <div class="row">
      <div class="col-md-4">
        <div class="product-box" data-name="CharmHalo Bracelet" data-color="Silver" data-image="bracelet1.jpg"
          data-price="68">
          <div class="image-container">
            <img src="bracelet1.jpg" alt="Image1" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>CharmHalo Bracelet</h6>
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="CuffVortex Bracelet" data-color="Black" data-image="bracelet2.jpg"
          data-price="65">
          <div class="image-container">
            <img src="bracelet2.jpg" alt="Image2" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>CuffVortex Bracelet</h6>
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="CelestiChain Bracelet" data-color="Black" data-image="bracelet3.jpg"
          data-price="53">
          <div class="image-container">
            <img src="bracelet3.jpg" alt="Image3" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>CelestiChain Bracelet</h6>
                <p class="text-muted">Black</p>
              </div>
              <h6>$53</h6>
            </div>
    ...
    <div class="row mt-4">
      <div class="col-md-4">
        <div class="product-box" data-name="RuneWrap Bracelet" data-color="Black" data-image="bracelet4.jpg"
          data-price="65">
          <div class="image-container">
            <img src="bracelet4.jpg" alt="Image4" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>RuneWrap Bracelet</h6>
                <p class="text-muted">Black</p>
              </div>
              <h6>$65</h6>
            </div>
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="NeonThread Bracelet" data-color="Green & Violet" data-image="bracelet5.jpg"
          data-price="69">
          <div class="image-container">
            <img src="bracelet5.jpg" alt="Image5" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>NeonThread Bracelet</h6>
                <p class="text-muted">Green & Violet</p>
              </div>
              <h6>$69</h6>
            </div>
            <div class="button-group mt-3">
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="IronClasp Bracelet" data-color="Gold & Silver" data-image="bracelet6.jpg"
          data-price="58">
          <div class="image-container">
            <img src="bracelet6.jpg" alt="Image6" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>IronClasp Bracelet</h6>
                <p class="text-muted">Gold & Silver</p>
              </div>
              <h6>$58</h6>
            </div>
            <div class="button-group mt-3">
