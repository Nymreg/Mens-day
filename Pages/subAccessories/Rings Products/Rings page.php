...
<head>
  ...
  <link rel="stylesheet" href="Rings page.css" />
...
<div class="content">
  <div class="header d-flex flex-column">
    <h6>Products</h6>
    <h2 style="font-weight: bold;">Rings</h2>
    <h4>Featured</h4>
  </div>
  ...
  <div class="products">
    <div class="row">
      <div class="col-md-4">
        <div class="product-box" data-name="LunaVow Ring" data-color="Silver" data-image="ring1.jpg" data-price="178">
          <div class="image-container">
            <img src="ring1.jpg" alt="Image1" class="img-fluid" />
          </div>
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="OnyxClasp Ring" data-color="Silver" data-image="ring2.jpg" data-price="160">
          <div class="image-container">
            <img src="ring2.jpg" alt="Image2" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>OnyxClasp Ring</h6>
                <p class="text-muted">Silver</p>
              </div>
              <h6>$160</h6>
            </div>
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="AuraLoop Ring" data-color="Silver" data-image="ring3.jpg" data-price="173">
          <div class="image-container">
            <img src="ring3.jpg" alt="Image3" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
    ...
    <div class="row mt-4">
      <div class="col-md-4">
        <div class="product-box" data-name="RogueSignet Ring" data-color="Gold" data-image="ring4.jpg" data-price="175">
          <div class="image-container">
            <img src="ring4.jpg" alt="Image4" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>RogueSignet Ring</h6>
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="EclipseBand Ring" data-color="Gold & Black" data-image="ring5.jpg"
          data-price="180">
          <div class="image-container">
            <img src="ring5.jpg" alt="Image5" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>EclipseBand Ring</h6>
                <p class="text-muted">Gold & Black</p>
              </div>
              <h6>$180</h6>
            </div>
            <div class="button-group mt-3">
      ...
      <div class="col-md-4">
        <div class="product-box" data-name="Serpentine Ring" data-color="Gold" data-image="ring6.jpg" data-price="186">
          <div class="image-container">
            <img src="ring6.jpg" alt="Image6" class="img-fluid" />
          </div>
          <div class="product-details">
            <div class="d-flex justify-content-between align-items-center"
              style="display:flex;justify-content:space-between;align-items:center;">
              <div>
                <h6>Serpentine Ring</h6>
                <p class="text-muted">Gold</p>
              </div>
              <h6>$186</h6>
            </div>
